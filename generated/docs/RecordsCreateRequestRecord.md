...
------------ | ------------- | ------------- | -------------
**form_id** | **string** | ID of the form this record belongs to | [default to undefined]
...
```typescript
import { RecordsCreateRequestRecord } from 'fulcrum-generated';

const instance: RecordsCreateRequestRecord = {
    form_id,
    latitude,
    longitude,
    form_values,
