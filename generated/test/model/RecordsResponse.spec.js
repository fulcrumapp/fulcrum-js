...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulcrumGenerated.RecordsResponse();
  });
  ...
  describe('RecordsResponse', function() {
    it('should create an instance of RecordsResponse', function() {
      // uncomment below and update the code to test RecordsResponse
      //var instance = new FulcrumGenerated.RecordsResponse();
      //expect(instance).to.be.a(FulcrumGenerated.RecordsResponse);
    });
