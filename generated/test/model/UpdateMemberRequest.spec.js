...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulcrumGenerated.UpdateMemberRequest();
  });
  ...
  describe('UpdateMemberRequest', function() {
    it('should create an instance of UpdateMemberRequest', function() {
      ...
      //var instance = new FulcrumGenerated.UpdateMemberRequest();
      //expect(instance).to.be.a(FulcrumGenerated.UpdateMemberRequest);
    });
