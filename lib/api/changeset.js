var Base, Changeset, async, mixins,
...
Changeset = (function(_super) {
  ...
  function Changeset() {
    return Changeset.__super__.constructor.apply(this, arguments);
  }

  Changeset.prototype.resource = 'changesets';

  Changeset.include(mixins.creatable);

  Changeset.include(mixins.findable);

  Changeset.include(mixins.updatable);

  Changeset.include(mixins.searchable);

  Changeset.prototype.close = function(id, cb) {
